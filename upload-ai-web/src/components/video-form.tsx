...
export function VideoInputForm(props: VideoFormProps) {
        ...
        <div className="space-y-6">
            <form onSubmit={handleVideoUpload} className="space-y-6">
                ...
                >
                    ...
                    {previewURL ? (
                        <video src={previewURL} controls={false} className="pointer-events-none aspect-video absolute inset-0" />
                    ) : (
                        <>
                            <FileVideo className="w-6 h-4" />
                            Carregar video
                        </>
                    )}
                </label>
